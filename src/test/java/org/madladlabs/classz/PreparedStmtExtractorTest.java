...
public class PreparedStmtExtractorTest {
    ...
    void testPreparedStatementDetection() throws Exception {
        ...
        try (InputStream in = Files.newInputStream(classFile)) {
            ...
            PreparedStmtExtractor extractor = new PreparedStmtExtractor();
            TestWriter writer = new TestWriter();

            System.out.println("Running PreparedStmtExtractor on class: " + ctClass.getName());
